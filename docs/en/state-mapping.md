...
Resume is an extension to the shared OpenAPI contract:
...
It maps to Paperclip's explicit Issue resume mutation. Rejection maps to Issue
cancel, preserving an audit comment in both cases.
